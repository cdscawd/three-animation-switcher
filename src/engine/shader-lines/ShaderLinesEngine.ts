...
import fragmentShader from './shaders/shader-lines.frag.glsl?raw'
import vertexShader from './shaders/shader-lines.vert.glsl?raw'
import type { ParamValues } from '../../params'

export interface ShaderLinesEngineOptions {
...
/** Matches 21st.dev designali-in/shader-lines bundle (Three.js ShaderMaterial) */
export class ShaderLinesEngine {
  ...
  constructor({ containerEl }: ShaderLinesEngineOptions) {
