...
import fragmentShader from './shaders/grid-shader.frag.glsl?raw'
import vertexShader from './shaders/grid-shader.vert.glsl?raw'
...
/** Matches 21st.dev dhileepkumargm/grid-shader bundle (ScrollingGridShader) */
export class GridShaderEngine {
